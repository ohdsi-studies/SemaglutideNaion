...
Various standardized analytics available in the OHDSI community will be applied. The Strategus pipeline will be used to call various packages in the HADES library for A) data characterization (A1‑cohort diagnostics, A2‑cohort features, A3‑incidence rates, A4‑self-controlled case-series).[@noauthor_ohdsistrategus_2024;@schuemie_health-analytics_2024]
