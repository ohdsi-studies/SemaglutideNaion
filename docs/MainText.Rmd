...
2. Cohort balance before and after PS adjustment, defined by the absolute standardized mean differences (SMDs) on extensive patient characteristics for each target-comparator-analysis
